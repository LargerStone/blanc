	...
	<template>
  <div id="editproject" class="container">
    <div class="row">
      <div class="col-6 offset-sm-3">
        ...
        <button class="btn btn-primary" @click="editProject()">提交</button>
      </div>
      ...
      methods:{
        ...
        findProject:function () {
          ...
          this.$api.post('/php/app/project/findProject.php',condition,function (success){
            if(success.error == 1){
               ...
               that.projectType = success.result[0].typeid;
               that.projectLevel = success.result[0].levelid;
        ...
        editProject:function () {
          ...
          if( title != ''&&text != ''&&projectType != '0'&&projectLevel != '0'&&status != '0'){
            ...
            this.$api.post('/php/app/project/editProject.php',condition,function (success){
              if(success.error == 1){
